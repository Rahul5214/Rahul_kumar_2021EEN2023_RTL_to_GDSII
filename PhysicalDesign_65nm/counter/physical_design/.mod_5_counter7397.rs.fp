...
#  Generated on:      Thu Oct 14 18:09:48 2021
#  Design:            mod_5_counter
#  Command:           floorPlan -coreMarginsBy die -site CORE -r 1 0.699856 4.5 4.5 4.5 4.5
###############################################################

Version: 8

Head Box: 0.0000 0.0000 9.2400 5.4000
IO Box: 0.0000 0.0000 9.2400 5.4000
Core Box: 0.0000 0.0000 9.2400 5.4000
UseStdUtil: false
...
##############################################################################
DefRow: ROW_0 CORE 0.0000 0.0000 FS 46 1 0.2000 0.0000
DefRow: ROW_1 CORE 0.0000 1.8000 N 46 1 0.2000 0.0000
DefRow: ROW_2 CORE 0.0000 3.6000 FS 46 1 0.2000 0.0000

############################################################################################
#  Track: dir start number space layer_num layer1 [firstColor] [isSameColor] [width] [rule]#
############################################################################################
Track: X 0.4000 12 0.8000 1 9
Track: Y 3.0000 1 6.0000 1 9
Track: Y 0.8000 6 0.8000 1 8
Track: X 0.4000 12 0.8000 1 8
Track: X 0.2000 23 0.4000 1 7
Track: Y 0.8000 6 0.8000 1 7
Track: Y 0.4000 13 0.4000 1 6
Track: X 0.2000 23 0.4000 1 6
Track: X 0.1000 46 0.2000 1 5
Track: Y 0.4000 13 0.4000 1 5
Track: Y 0.2000 26 0.2000 1 4
Track: X 0.1000 46 0.2000 1 4
Track: X 0.1000 46 0.2000 1 3
Track: Y 0.2000 26 0.2000 1 3
Track: Y 0.2000 26 0.2000 1 2
Track: X 0.1000 46 0.2000 1 2
Track: X 0.1000 46 0.2000 1 1
Track: Y 0.2000 26 0.2000 1 1

######################################################
#  GCellGrid: dir start number space                 #
######################################################
GCellGrid: X 8.1000 2 1.1400
GCellGrid: X 0.1000 5 2.0000
GCellGrid: X 0.0000 2 0.1000
GCellGrid: Y 4.2000 2 1.2000
GCellGrid: Y 0.2000 3 2.0000
...
<HierarchicalPartitions>
    ...
    <Partition name="mod_5_counter" hinst="" coreToLeft=0.0000 coreToRight=0.0000 coreToTop=0.0000 coreToBottom=0.0000 pinSpacingNorth=-1 pinSpacingWest=-1 pinSpacingSouth=-1 pinSpacingEast=-1 blockedLayers=0x1ff orient=R0>
...
#  SprFile: <file_name>                                         #
#################################################################
SprFile: .mod_5_counter7397.rs.fp.spr
